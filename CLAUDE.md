...
**Osiris** — multi-tenant SaaS automating operations for service businesses. Turborepo monorepo with two apps: **House Cleaning** (Spotless Scrubbers, Cedar Rapids, West Niagara) and **Window Washing** (WinBros). Next.js 16 (App Router) on Vercel, Supabase (Postgres + RLS), Stripe.
