...
const navigation = [
  ...
  { name: "Quotes", href: "/quotes", icon: FileText, adminOnly: false, tenantOnly: "winbros" },
  { name: "Crew Assignment", href: "/crews", icon: Users, adminOnly: false, tenantOnly: "winbros" },
  { name: "Scheduling", href: "/schedule", icon: CalendarDays, adminOnly: false, tenantOnly: "winbros" },
  { name: "Service Plan Scheduling", href: "/service-plan-schedule", icon: Calendar, adminOnly: false, tenantOnly: "winbros" },
  { name: "Service Plan Hub", href: "/service-plan-hub", icon: Repeat, adminOnly: false, tenantOnly: "winbros" },
  { name: "Payroll", href: "/payroll", icon: DollarSign, adminOnly: false, tenantOnly: "winbros" },
  ...
  { name: "Control Center", href: "/control-center", icon: Sliders, adminOnly: false, tenantOnly: "winbros" },
